var http = require('http'),
	...
	mongoDB = require('./db').init('mydb');
	// storage = require('./storage');

app.use(bodyParser.json()); // to support JSON-encoded bodies


require('./drawing').init(app, mongoDB);
...
// 	fields: ['width', 'height', 'x', 'y', 'color', 'fillOpacity', 'radius', 'title', 'type', 'prev', 'background'] // missing stroke.color and stroke.width (cannot contain ".")
// });
// storage.addCollection(app, {
// 	endpoint: 'drawing',
// 	collection: 'drawings',
